...
PRIVATE_KEY_PATH = Path(
    os.getenv("RECEIVER_PRIVATE_KEY", "keys/receiver_private.pem")
)

PUBLIC_KEY_PATH = Path(
    os.getenv("RECEIVER_PUBLIC_KEY", "keys/receiver_public.pem")
)
...
def main() -> None:
    ...
    print("[!] Chỉ chia sẻ receiver_public.pem cho Sender")
